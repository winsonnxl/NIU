                    ...
                    if(err){
                        ...
                        if(results.length>0){
                            ...
                            for(var i=0;i<results.length;i++){
                                ...
                                'sys_name':global.sysname_list[results[i].bug_sys]/*global.sys_list_sys[results[i].bug_sys]*/,
                                    'sys_dep':global.sysname_list[results[i].bug_dep]/*global.sys_list_deps[results[i].bug_sys+''+results[i].bug_dep]*/,
                                    'sys_model':global.sysname_list[results[i].bug_model]/*global.sys_list_models[results[i].bug_sys+''+results[i].bug_dep+''+results[i].bug_model]*/,
                ...
                conn.query(sql,bugid,function(err,result){
                    if(err){
                        ...
                        if(result.length>0){
                            ...
                            'bug_sys':global.sysname_list[result[0].bug_sys]/*global.sys_list_sys[result[0].bug_sys]*/,
                            'bug_dep':global.sysname_list[result[0].bug_dep]/*global.sys_list_deps[result[0].bug_sys+''+result[0].bug_dep]*/,
                            'bug_model':global.sysname_list[result[0].bug_model]/*global.sys_list_models[result[0].bug_sys+''+result[0].bug_dep+''+result[0].bug_model]*/,
